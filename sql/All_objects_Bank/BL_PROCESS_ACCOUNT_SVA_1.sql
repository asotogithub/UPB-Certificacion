--------------------------------------------------------
--  DDL for Package Body BL_PROCESS_ACCOUNT_SVA
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "BANK"."BL_PROCESS_ACCOUNT_SVA" AS
  ...
  BEGIN
    ...
    IF pi_type_transaction = 'DEPOSIT' THEN
    ...
    ELSIF pi_type_transaction = 'WITHDRAWAL' THEN
